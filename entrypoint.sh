...
crontab -l | { cat; echo "0 * * * * /home/minecraft/scripts/generate-map.sh >> /home/minecraft/generation.log 2>&1"; } | crontab -
crontab -l | { cat; echo "*/5 * * * * /home/minecraft/scripts/update-poi.sh >> /home/minecraft/update.log 2>&1"; } | crontab -
